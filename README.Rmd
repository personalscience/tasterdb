...
*Important*: The most important function is <not yet final>. Run this to drop and then load from scratch everything in the current database.

The very first time you set up a new Postgres database, run the function <not yet final>. It's okay to run this as many times as you like; it won't do anything if the database is already set up properly.
